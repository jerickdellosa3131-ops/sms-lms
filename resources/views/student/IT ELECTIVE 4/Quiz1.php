  ...
  <main class="main-content flex-grow-1">
            ...
            <div class="container">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?php echo route('student.class-portal'); ?>">ITE ELECTIVE 4</a></li>
                        <li class="breadcrumb-item"><a href="<?php echo route('student.class-portal'); ?>">Module 1</a></li>
