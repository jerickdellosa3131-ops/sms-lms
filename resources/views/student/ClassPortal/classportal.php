...
<div class="d-flex justify-content-between align-items-center mb-5 pb-3 border-bottom border-secondary portal-header">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h2 class="mb-0 fw-bold text-black">Student Courses</h2>
                                <p class="mb-0 text-black">Your enrolled subjects for this semester</p>
                            </div>
                        </div>
                        <a href="<?php echo route('student.dashboard'); ?>" class="btn btn-solid-blue fw-medium d-none d-md-block">
                    ...
                    <div class="row g-4">
                        <?php if($classes->count() > 0): ?>
                            <?php 
                            $cardColors = ['card-bg-1', 'card-bg-2', 'card-bg-3', 'card-bg-4'];
                            $colorIndex = 0;
                            foreach($classes as $class): 
                                $cardClass = $cardColors[$colorIndex % 4];
                                $colorIndex++;
                            ?>
                            <div class="col-md-6 col-lg-4">
                                <div class="subject-card <?php echo $cardClass; ?>">
                                    ...
                                    <div>
                                        ...
                                        <p class="subtitle"><?php echo htmlspecialchars($class->subject_name ?? $class->class_code); ?></p>
                                    </div>
                                    <div class="instructor-section mt-3">
                                        <p class="mb-1"><i class="bi bi-person-circle me-2"></i><strong>Instructor:</strong></p>
                                        <p class="text-muted"><?php echo htmlspecialchars($class->teacher_first . ' ' . $class->teacher_last); ?></p>
                                    </div>
                                    <div class="schedule-section mt-2">
                                        <p class="mb-0"><i class="bi bi-calendar3 me-2"></i><?php echo htmlspecialchars($class->schedule_days); ?></p>
                                        <p class="text-muted"><?php echo date('g:i A', strtotime($class->schedule_time_start)) . ' - ' . date('g:i A', strtotime($class->schedule_time_end)); ?></p>
                                        <p class="mb-0"><i class="bi bi-geo-alt me-2"></i><?php echo htmlspecialchars($class->room); ?></p>
                                    </div>
                        ...
                        <?php else: ?>
                            <div class="col-12">
                                <div class="alert alert-info">
                                    <i class="bi bi-info-circle me-2"></i>No enrolled classes yet.
                                </div>
                            </div>
                        <?php endif; ?>
                    </div>

                    <!-- Old hardcoded cards removed -->
                    <div class="row g-4" style="display:none;">
                        <div class="col-md-6 col-lg-3">
                            <div class="subject-card card-bg-3">
