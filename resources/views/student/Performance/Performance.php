...
<body>
 ...
 <div class="d-flex justify-content-between align-items-center mb-5 pb-3 border-bottom">
                        ...
                        <a href="<?php echo route('student.dashboard'); ?>" class="btn btn-primary-themed fw-medium d-none d-md-block">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="tile-card h-100">
                                <div class="card-body">
                                    ...
                                    <a href="<?php echo route('student.grades'); ?>" class="btn mt-auto">View Grades</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="tile-card h-100">
                                <div class="card-body">
                                    ...
                                    <a href="<?php echo route('student.class-portal'); ?>" class="btn mt-auto">View Progress</a>
                                </div>
                            </div>
                        </div>
