            ...
            <div class="card-body p-4">
                ...
                <div class="col-md-3">
                  <div class="card border-0 shadow-sm h-100">
                    <div class="card-body text-center">
                      ...
                      <a href="<?php echo route('student.class-portal'); ?>" class="btn btn-outline-info btn-sm">Go</a>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-3">
                  <div class="card border-0 shadow-sm h-100">
                    <div class="card-body text-center">
                      ...
                      <a href="<?php echo route('student.performance'); ?>" class="btn btn-outline-warning btn-sm">Go</a>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-3">
                  <div class="card border-0 shadow-sm h-100">
                    <div class="card-body text-center">
                      ...
                      <a href="<?php echo route('student.grades'); ?>" class="btn btn-outline-danger btn-sm">Go</a>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="mt-4">
                ...
                <div class="d-flex flex-wrap gap-2 justify-content-center">
                  ...
                  <a href="<?php echo route('student.assignments'); ?>" class="btn btn-outline-warning">
